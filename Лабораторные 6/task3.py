...
def to_csv_file(filename, headers, rows, delimiter, new_line):  # TODO реализовать функцию to_csv_file
    with open(filename, "w") as f:
        repr(f.writelines(delimiter.join(headers)))
        repr(f.writelines(new_line))
